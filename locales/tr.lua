Locales['tr'] = {
  ...
  ['police_wear'] = 'Police Kıyafeti',
  ['gilet_wear'] = 'Turuncu yansıtıcı ceket',
  ['bullet_wear'] = 'Kurşun geçirmez yelek',
  ['no_outfit'] = 'Sana uyan üniforma yok!',
  ['open_cloackroom'] = '~y~clothes~s~ değişmek için ~INPUT_CONTEXT~ tuşuna basın.',
  -- Armory
  ['remove_object'] = 'Nesneyi al',
  ['deposit_object'] = 'Nesneyi bırak',
  ['get_weapon'] = 'Cephanelikten silahı al',
  ['put_weapon'] = 'Silahı cephaneliğe bırak',
  ['buy_weapons'] = 'Silah satın al',
  ['armory'] = 'Cephanelik',
  ['open_armory'] = '~y~Cephaneliğe~s~ erişmek için ~INPUT_CONTEXT~ butonuna basın.',
  ['armory_owned'] = 'Sahip olunan',
  ['armory_free'] = 'Ücretsiz',
  ['armory_item'] = '₺%s',
  ['armory_weapontitle'] = 'Cephanelik - Silah satın al',
  ['armory_componenttitle'] = 'Cephanelik - Silah ekipmanları',
  ['armory_bought'] = '~y~%s~s~ için ~r~$%s~s~ aldın.',
  ['armory_money'] = 'Bu silahı alamazsın',
  ['armory_hascomponent'] = 'Bu ekipman zaten takılı.',
  ['get_weapon_menu'] = 'Cephanelik - Silah Al',
  ['put_weapon_menu'] = 'Ceptanelik - Silah Bırak',
  -- Vehicles
  ['vehicle_menu'] = 'Araçlar',
  ['vehicle_blocked'] = 'Belirme noktaları şu an kullanılamıyor.',
  ['garage_prompt'] = '~y~Araç aksiyonlarına~s~ erişmek için ~INPUT_CONTEXT~ butonuna basın.',
  ['garage_title'] = 'Araç Aksiyonları',
  ['garage_stored'] = 'Garajda',
  ['garage_notstored'] = 'Garajda Değil',
  ['garage_storing'] = 'Arabayı garaja koymak için etrafında kimsenin olmadığına emin ol.',
  ['garage_has_stored'] = 'Araç garaja konuldu',
  ['garage_has_notstored'] = 'Yakınlarda sahip olduğun araç bulunmuyor.',
  ['garage_notavailable'] = 'Aracın garaja konulamıyor.',
  ['garage_blocked'] = 'Kullanılabilir belirme noktası yok.',
